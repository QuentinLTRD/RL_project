...
if __name__ == "__main__":
    ...
    num_agent = int(input("Choisir parmi 0 (agent faible), 1 (agent moyen) ou 2 (agent fort) : "))
    tour = int(input("Choisir 0 si vous souhaitez commencer, 1 sinon : "))
    charger_et_jouer(f"../models/tictactoe_agent{noms_agents[num_agent]}.pt", tour_agent=2-tour)
